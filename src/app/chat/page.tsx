  ...
  const printRecents = sortedRecents.map((item, pos) => {
    ...
    return (
      <li
        ...
        key={pos}
        style={{
          backgroundColor: withUsername === item.username ? "#dfdfdf" : "",
        }}
      >
  ...
  return (
    <div className="chat">
      <div className="content">
        <Toaster></Toaster>
        {viewportWidth < 900 && (
          <Header toggleRecentsPressed={toggleRecentsPressed} />
        )}
        <div className="page">
          ...
          <div className="board">
              ...
              <div className="interface">
                ...
                {withUsername == "" && (
                  <div className="nocontact">
                    ...
                    <div
                      onClick={() =>
                        setWithUsernameAndReadMessage(currentUsername)
                      }
                      className="option"
                    >
                      <p>Go to my workspace</p>
                      <Image
                        src={Arrow2}
                        alt="Arrow right"
                        width={25}
                    ...
                    <Link
                      href="https://github.com/tylerhaisman/Meteorite"
                      target="_blank"
                    >
                      <div className="option">
                        <p>Learn how to use Meteorite</p>
                        <Image
                          src={Arrow2}
                          alt="Arrow right"
                          width={25}
              ...
              <div className="recents">
                ...
                <div className="middle">
                  ...
                  {sortedRecents.length > 0 && (
                    <ul className="people">{printRecents}</ul>
                  )}
                ...
                <div className="bottom">
                  ...
                  >
                    New Chat{" "}
                    <Image src={Plus} alt="Send" width={20} height={20} />
                  </button>
            ...
            {viewportWidth < 900 && recentsIsPressed && (
              <div className="recents mobile">
                <div className="top">
                  <form className="searchbar" onSubmit={handleSearchSubmit}>
                    <input
                      placeholder="Add username"
